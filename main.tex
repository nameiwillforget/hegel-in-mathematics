...
While it is somewhat reductive, the following geometric interpretation, which is original work, is mathematically strict and can be used as a visualization of the concepts involved. A unity of opposites can be thought of as a line

[insert image]

with the opposites being the end points of the line, spanning between each other the category $C$ while being the same as abstract points. A unity of unities can then be thought of as a further line ending in one of the end points of
